...
const CreatetableSelect = dynamic(() => import("react-select/creatable"), {
  ssr: false,
});
...
const formSchema = z.object({
  ...
  categoryId: z.string(),
  tags: array(object({ label: z.string(), value: z.string() })),
  categories: array(object({ id: z.string(), name: z.string() })),
  status: z.string(),
